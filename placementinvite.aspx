<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="placementinvite.aspx.cs" Inherits="TrainingPlacement.PlacementPartner" %>
  ...
  <body>
    <div class="testbox">
      <form action="/" runat="server">
        <div class="banner">
          <h1>Placement Partnership Invitation Form</h1>
        </div>
        <div class="item">
